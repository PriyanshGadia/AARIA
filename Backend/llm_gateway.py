...
class LLMGateway:
    ...
    async def _fallback_llm(self, request: LLMRequest) -> LLMResponse:
        """Simple rule-based fallback when LLMs are unavailable"""
        prompt_lower = request.prompt.lower()
        
        # Simple pattern matching for common queries
        if any(word in prompt_lower for word in ["who are you", "what are you", "introduce yourself"]):
            response = "I am AARIA, your personal AI assistant. I'm designed to help you with various tasks while protecting your privacy and learning from our interactions."
            ...
            response = "I'm functioning optimally and ready to help. How can I assist you?"
        elif "?" in request.prompt:
            response = "I understand your question. I'm currently using my basic reasoning capabilities. For more advanced understanding, you can enable cloud LLM integration or use a local model like Ollama."
        else:
            response = "I understand. I'm processing your request using my core capabilities. How can I assist you further?"
